...
//Last stable: https://jsfiddle.net/mo2gr3e9/
...
$(function() {
  ...
  // Atlas
  table_loader("atlas1", abilityGenerator(AtlasMap.土石坍方));
  table_loader("atlas2", abilityGenerator(AtlasMap.大地構築));
  table_loader("atlas3", abilityGenerator(AtlasMap.石化凝視));
  table_loader("atlas4", abilityGenerator(AtlasMap.漫步石者));
  table_loader("atlas1_aug", augmentGenerator(AtlasMap, "土石坍方", "化像之道"));
  table_loader("atlas3_aug", augmentGenerator(AtlasMap, "石化凝視", "礦石凝視"));
  table_loader("atlas4_aug", augmentGenerator(AtlasMap, "漫步石者", "巨大石者"));
